...
- First Login 
- Then Send Message Link Of Any Channel That You've Joined In Your Login Account.

FOR BOT :-
- Send Link In This Format : https://t.me/b/bot_username/message_id (use plus messenger for message_id)

FOR GROUP TOPIC :- 
- (For Private Group) Group Topic Link Is Like :- https://t.me/c/xxxxxxxxx/first_id/second_id
But, Send Like This :- https://t.me/c/xxxxxxx/second_id (remove first id and one /)
- (For Public Group) Follow Private Link Step But Remove "/c" from link. Ex - https://t.me/username/second_id
...
SETTINGS_TXT = """
**ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴛʜᴇ sᴇᴛᴛɪɴɢs sᴇᴄᴛɪᴏɴ. ʜᴇʀᴇ, ʏᴏᴜ ᴄᴀɴ ᴄʜᴏᴏsᴇ ʙᴜᴛᴛᴏɴ: ᴄᴀᴘᴛɪᴏɴ ᴏʀ sᴇssɪᴏɴ ᴀɴᴅ ᴛʜᴜᴍʙɴᴀɪʟ.**
"""
...
SESSION_TXT = """
**ᴄᴜsᴛᴏᴍɪᴢᴇ ᴛʜᴇ ʙᴏᴛ's sᴇssɪᴏɴ ʜᴇʀᴇ ᴛᴏ ᴛᴀɪʟᴏʀ ɪᴛ ᴛᴏ ʏᴏᴜʀ ᴘʀᴇғᴇʀᴇɴᴄᴇs ᴀɴᴅ ɴᴇᴇᴅs!**
"""

CHANNEL_TXT = """
**ᴄᴜsᴛᴏᴍɪᴢᴇ ᴛʜᴇ ʙᴏᴛ's ᴄʜᴀɴɴᴇʟ ʜᴇʀᴇ ᴛᴏ ᴛᴀɪʟᴏʀ ɪᴛ ᴛᴏ ʏᴏᴜʀ ᴘʀᴇғᴇʀᴇɴᴄᴇs ᴀɴᴅ ɴᴇᴇᴅs!**
"""
